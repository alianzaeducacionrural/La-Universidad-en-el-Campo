    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl max-w-md w-full shadow-xl max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b bg-white sticky top-0 z-10 flex items-start justify-between gap-3">
          <div><h3 className="text-lg font-bold">✏️ Editar Seguimiento</h3><p className="text-sm text-gray-600">Estudiante: <span className="font-medium">{seguimiento.estudiante?.nombre_completo || 'N/A'}</span></p></div>
