// =============================================
// CONSOLIDADO: SEGUIMIENTOS DE UNIVERSIDAD
// =============================================
...
import TarjetaKPI from '../estadisticas/TarjetaKPI';
...
export default function ConsolidadoSeguimientosUniversidad({ onVerPerfil }) {
  ...
  async function handleGuardarEdicion(id, datos) {
  ...
  async function handleEliminar(seguimiento) {
    ...
    if (resultado.success) {
      ...
      setSeguimientos(prev => prev.filter(s => s.id !== seguimiento.id));
    } else {
  ...
  return (
    <div>
              ...
              <div key={s.id} className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-sm transition">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      onClick={() => { setSeguimientoEditando(s); setModalEditar(true); }}
                      className="bg-white hover:bg-gray-50 text-gray-600 px-2.5 py-1.5 rounded-lg text-xs font-medium transition border border-gray-200"
                    ...
                    <button
                      ...
                      className="bg-white hover:bg-red-50 text-red-500 px-2.5 py-1.5 rounded-lg text-xs font-medium transition border border-gray-200"
      ...
      <ModalEditarSeguimientoUniversidad
        isOpen={modalEditar}
        onClose={() => { setModalEditar(false); setSeguimientoEditando(null); }}
