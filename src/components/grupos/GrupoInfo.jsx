...
export default function GrupoInfo({ 
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6 shadow-sm">
      ...
      <div className="grid grid-cols-3 gap-2 pt-3 border-t border-gray-200 lg:flex lg:flex-wrap lg:items-center lg:gap-2">
        {padrino && (
          <>
            <button
              onClick={() => setModalRegistrarAccion(true)}
              className="w-full lg:w-auto text-center bg-primary hover:bg-primary-dark text-white px-2 py-2 lg:px-4 lg:py-2.5 rounded-lg text-xs lg:text-sm font-medium transition shadow-sm"
            >
              ➕ Registrar Acción
            </button>
            <button
        ...
        {enlaces.estudiantes && (
          <a href={enlaces.estudiantes} target="_blank" rel="noopener noreferrer"
            className="w-full lg:w-auto text-center bg-green-500 hover:bg-green-600 text-white px-2 py-2 lg:px-4 lg:py-2.5 rounded-lg text-xs lg:text-sm font-medium transition shadow-sm"
          >
            💬 Estudiantes
          </a>
        )}
        {enlaces.acudientes && (
          <a href={enlaces.acudientes} target="_blank" rel="noopener noreferrer"
            className="w-full lg:w-auto text-center bg-blue-500 hover:bg-blue-600 text-white px-2 py-2 lg:px-4 lg:py-2.5 rounded-lg text-xs lg:text-sm font-medium transition shadow-sm"
          >
            👨‍👩‍👧 Acudientes
          </a>
        )}
        ...
        <button
          ...
          className="w-full lg:w-auto text-center bg-green-50 hover:bg-green-100 text-green-700 px-2 py-2 lg:px-4 lg:py-2.5 rounded-lg text-xs lg:text-sm font-medium transition border-2 border-green-300 shadow-sm"
        >
          💬 WhatsApp
        </button>
      </div>
